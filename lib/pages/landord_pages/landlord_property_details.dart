...
class _LandlordPropertyDetailsPageState extends State<LandlordPropertyDetailsPage> {
  ...
  ListView rentalPropertyApplicationsSection(BuildContext context, Size screenSize) {
    double width = screenSize.width;
    double height = screenSize.height;
  ...
  // Future<Map<String, dynamic>?> fetchPropertyApplication() async {
  //   try {
  //     // Fetch the rental property's applications
  //     // and store in applicationSnapshot
  //     QuerySnapshot applicationSnapshots = await FirebaseFirestore.instance
  //         .collection("applications")
  //         .where("rentalID", isEqualTo: widget.snapshotId)
  //         .get();
      
  //     // Check if applicationSnapshots contains data or not
