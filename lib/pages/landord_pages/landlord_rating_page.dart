...
class _LandlordRatingPageState extends State<LandlordRatingPage> {
          ...
          children: [
            ...
            TextField(
              ...
              decoration: InputDecoration(
                hintText: 'Share more thoughts on the tenant to help others',
  ...
  Row _buildLandlordInformation() {
    return Row(
      children: [
        ...
        CustomCircleAvatar(
          imageURL: widget.ratingInfo['tenantImageURL'],
          name: widget.ratingInfo['tenantName']!,
          radius: 28,
          fontSize: 22,
        ),
  ...
  void submitRating(BuildContext context) async {
    ...
    try {
      ...
      final List<LandlordEndedTenancy> updatedEndedTenancies =
          await TenancyService.fetchLandlordEndedTenancies();
