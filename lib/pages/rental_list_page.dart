...
class _RentalListPageState extends State<RentalListPage> {
  Future<List<Map<String, dynamic>>?>? rentalListFuture;
  ...
  Future<List<Map<String, dynamic>>?> fetchRentalList() async {
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return Padding(
                              ...
                              child: InkWell(
                                ...
                                child: Container(
                                  constraints:
                                      const BoxConstraints(minHeight: 189),
                                  // height: 189,
