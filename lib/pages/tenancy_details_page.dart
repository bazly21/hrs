...
class _TenancyDetailsPageState extends State<TenancyDetailsPage> {
                  ...
                  child: FutureBuilder<Map<String, dynamic>?>(
                    ...
                    builder: (context, snapshot) {
                      if (snapshot.connectionState == ConnectionState.waiting) {
                        ...
                        final Map<String, dynamic> tenancyData = snapshot.data!;
                        return _buildTenancyInfo(context, tenancyData);
                      }
                      // Act as placeholder
                        ...
                        child: Column(
                          children: [
                            ...
                            RentalDetails(
                                title: "End Date",
                                text:
                                    formatDate(tenancyData['tenancyEndDate'])),
                          ],
                        ),
                      ),
                    ),
  ...
  Future<void> _refreshTenancyInfo() async {
    await _rentalService.fetchTenancyInfo(_auth.currentUser!.uid).then((value) {
      setState(() {
