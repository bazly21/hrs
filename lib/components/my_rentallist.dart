...
class MyRentalList extends StatelessWidget {
  ...
  Future<List<Map<String, dynamic>>?> fetchRentalDetails() async {
    // Fetch all the data inside properties collection
    QuerySnapshot propertiesSnapshot =
        await FirebaseFirestore.instance.collection("properties").get();

    List<Map<String, dynamic>> properties = propertiesSnapshot.docs
          ...
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            return ListView.builder(
              ...
              itemBuilder: (context, index) {
                Map<String, dynamic> propertyData = snapshot.data![index];
                return Padding(
                  padding:
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                                ...
                                image: DecorationImage(
                                    image:
                                        NetworkImage(propertyData["image"][0]),
                                    fit: BoxFit.cover)),
                          ),
                          Expanded(
                            child: ConstrainedBox(
                              constraints: const BoxConstraints(
                                  minHeight:
                                      189), // Set minimum height 189 pixel
                              child: Padding(
